...
APP_NAME = "SMB Vision Ops"
APP_SLUG = "visionopsapi"
DEFAULT_BASE_URL = "https://smb-vision-ops.up.railway.app"
...
FOLLOWUP_FROM_EMAIL = os.getenv("FOLLOWUP_FROM_EMAIL", "SMB Vision Ops <joseph@dataweaveai.com>").strip()
...
STARTER_PRICE_LABEL = os.getenv("STARTER_PRICE_LABEL", "$79/mo").strip()
...
STARTER_MONTHLY_COST_CAP_USD = float(os.getenv("STARTER_MONTHLY_COST_CAP_USD", "15.8"))
